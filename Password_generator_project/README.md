...
Developed the GUI using Tkinter for interactive password generation

Implemented multiple password strength levels: Weak, Medium, Strong

Ensured no duplicate passwords are generated using a global set

Added functionality to save passwords in both text and CSV formats

Integrated clipboard copy functionality for convenience
